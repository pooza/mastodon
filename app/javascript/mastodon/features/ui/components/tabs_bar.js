...
export const links = [
  <NavLink className='tabs-bar__link' to='/tags/precure_fun' data-preview-title-id='column.precure' data-preview-icon='hashtag' ><Icon id='hashtag' fixedWidth /><FormattedMessage id='tabs_bar.precure_timeline' defaultMessage='precure_fun' /></NavLink>,
